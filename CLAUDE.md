...
repo root; it adds `src/` to its own path). **Adding a new algebra is a one-line edit** to the
...
- After editing the generator, regenerate and re-run the suite (the conformance tests guard
